...
mixin _$SplashController on _SplashControllerBase, Store {
  ...
  final _$existsEntriesAsyncAction =
      AsyncAction('_SplashControllerBase.existsEntries');

  @override
  Future<List<dynamic>> existsEntries() {
    return _$existsEntriesAsyncAction.run(() => super.existsEntries());
  }

...
class GeneralDatabase extends _$GeneralDatabase implements IGeneralDatabase {
  ...
  Future<void> populateDatabase() async {
    ...
    var categoriesModelList = [
      Categorie(name: 'Restaurantes', color: '#2ecc71', isDebit: 1, isCredit: null, id: null, isDefault: null),
      Categorie(name: 'Empréstimos', color: '#3498db', isDebit: 1, id: null, isCredit: null, isDefault: null),
      Categorie(name: 'Alimentação', color: '#9b59b6', isDebit: 1, id: null, isCredit: null, isDefault: 1),
      ...
      Categorie(name: 'Dívidas', color: '#1abc9c', isDebit: 1, isCredit: null, id: null, isDefault: null),
      Categorie(name: 'Família', color: '#d35400', isDebit: 1, id: null, isCredit: null, isDefault: null),
      Categorie(name: 'Compras', color: '#e67e22', isDebit: 1, id: null, isCredit: null, isDefault: 1),
      Categorie(name: 'Mercado', color: '#c0392b', isDebit: 1, id: null, isCredit: null, isDefault: 1),
      Categorie(name: 'Outros', color: '#ecf0f1', isDebit: 1, id: null, isCredit: null, isDefault: 1),
      Categorie(name: 'Lazer', color: '#bdc3c7', isDebit: 1, id: null, isCredit: null, isDefault: null),
      Categorie(name: 'Casa', color: '#95a5a6', isDebit: 1, id: null, isCredit: null, isDefault: 1),
